...
function updatePaginationControls() {
    ...
    const pageButtons = document.querySelectorAll('#pagination .pagination__button');
    pageButtons.forEach((btn, index) => {
        btn.classList.remove('active'); // Remove any existing highlights
