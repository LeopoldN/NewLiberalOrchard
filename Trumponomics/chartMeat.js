function renderChart() {
    ...
    const thisFileName = "/Trumponomics/ground_beef.json?v=1";
    const xDomainLow = 2.5;
    const xDomainHigh = 6;
    var thisTitle = "US Average Ground Beef Prices / Pound";
    ...
    if(containerWidth <= mobileSize){
        ...
        logoSize = 50;
        thisYTitle = "";
        thisTitle = "Average Meat Prices";
        containerHeight = 300;
        containerWidth = 340;
    }

    var oLink1 = "https://fred.stlouisfed.org/series/APU0000703112";
    var oLink2 = "https://fred.stlouisfed.org/series/FYFSGDA188S";
    var oLinkName = "Beef Price Source";
