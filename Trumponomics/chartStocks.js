function renderChart() {
    ...
    const thisFileName = "/Trumponomics/SP500.json?v=1";
    const xDomainLow = 1700;
    const xDomainHigh = 6500;
    var thisTitle = "US Stock Market (500 Biggest Companies)";
    var thisYTitle = "SP500 index";
    ...
    if(containerWidth <= mobileSize){
        ...
        logoSize = 50;
        thisYTitle = "";
        thisTitle = "SP500 Prices";
        containerHeight = 300;
        containerWidth = 340;
    }

    var oLink1 = "https://fred.stlouisfed.org/series/SP500";
    var oLink2 = "https://fred.stlouisfed.org/series/FYFSGDA188S";
    var oLinkName = "Stock Price Source";
    ...
    d3.json(thisFileName).then(data => {
        data.forEach(d => {
            ...
            d[jsonX] = (d[jsonX] !== null && d[jsonX] !== ".") ? +d[jsonX] : null;
        ...
        const lineX1 = d3.line()
            .defined(d => d[jsonX] !== null) // Skip points with null SP500 values
            .x(d => x(d.date))
            .y(d => y(d[jsonX]));
    ...
    if(isStepCurve && isTwoVariables){
        ...
        const eventDates = [
            {date: "2017-01-01", label: "Trump Starts"},
            {date: "2018-01-01", label: "TCJA Passed"},
            {date: "2021-01-01", label: "Biden Starts"},
