function renderChart() {
    ...
    const thisFileName = "/Trumponomics/w_milk_gal.json?v=1";
    const xDomainLow = 2.5;
    const xDomainHigh = 4.5;
    var thisTitle = "US Average Milk Prices / Gal";
    var thisYTitle = "Cost per Gal in $";
    ...
    if(containerWidth <= mobileSize){
        ...
        logoSize = 50;
        thisYTitle = "";
        thisTitle = "Average Milk Prices";
        containerHeight = 300;
        containerWidth = 340;
    }

    var oLink1 = "https://fred.stlouisfed.org/series/APU0000709112";
    var oLink2 = "https://fred.stlouisfed.org/series/FYFSGDA188S";
    var oLinkName = "Milk Price Source";
